...
function generate_import_items_csv($stock_locations,$attributes)
{
	...
	$csv_headers .= 'Id,Barcode,"Item Name",Category,"Supplier ID","Purchase Price","Sales Price","MRP Price","Stock",HSN Code,"Tax 1 Name","Tax 1 Percent","Tax 2 Name","Tax 2 Percent","Reorder Level",Description,';
